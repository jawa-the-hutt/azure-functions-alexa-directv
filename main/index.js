import * as AlexaDirectTV from "./classes";
...
export default (context, req) => {
    context.log("Staring up the Azure Function for Alexa!");
    ...
    let getThePartyStarted = async () => {
        try {
            // create the instance of the class
            let action = new AlexaDirectTV[params.class](context, req);
